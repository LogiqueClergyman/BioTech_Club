        ...
        {/* <div className="flex flex-wrap mx-4">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="w-full mb-10">
              <a
                href="/#"
                className="mb-6 felx flex-wrap inline-block max-w-[160px]"
              >
                <img src={logo} className="max-w-full" alt="" />
                <p className="font-bold text-xl">Biotech Club | GLAU</p>
              </a>
              <p className="text-base mb-7 text-body-color">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nam
                veniam nobis laborum?
              </p>
          ...
          <div header="Know About">
            ...
            <div className="my-3">
              <a
                href="https://www.gla.ac.in/academics/faculty-of-education"
                target="_blank"
              >
            ...
            <div className="my-3">
              <a href="http://library.glauniversity.in/" target="_blank">
                Library
              </a>
            </div>
          </div>
          <div header="Biotech">
            <div className="my-3">
              <a
                href="https://www.gla.ac.in/courses/graduate/btech-biotechnology"
                target="_blank"
              >
            ...
            <div className="my-3">
              <a
                href="https://www.gla.ac.in/course-details.aspx?mpgid=129&pgidtrail=129&courseid=118"
                target="_blank"
              >
                B.SC. BIOTECH
              </a>
          ...
          <div header="Quick Links">
            <NavLink link="/sigin" label="Login" />
            <NavLink link="/event" label="Event" />
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="w-full mb-10">
              ...
              <div className="flex items-center mb-6">
                <a
                  href="/#"
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-black hover:border-white text-dark hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width={8}
                    height={16}
              ...
              <p className="text-base text-body-color">
                {" "}
                © {new Date().getFullYear()} Biotech Club{" "}
              </p>
            </div>
          </div>
        </div> */}
      </div>
      <footer className="footer p-10 md:flex justify-around bg-teal-500 text-neutral-content">
        <div className="md:flex">
          ...
          <p className="md:max-w-sm w-xs">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
            aspernatur explicabo, iure culpa libero sint. Culpa consequuntur hic
            error exercitationem voluptates consequatur quod iure enim,
            voluptatem tempora corrupti doloribus tenetur alias non suscipit
            quibusdam? Mollitia modi reprehenderit possimus magni
          </p>
        </div>
        ...
        <div className="pt-5">
          <div>
            ...
            <div className="grid grid-flow-col gap-4 mt-2">
              <a
                href="/#"
                className="mr-3 flex h-8 w-8 items-center justify-center rounded-full hover:border-white border border-black text-dark hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
              >
                <svg
                  width={8}
                  height={16}
          ...
          <div className="grid grid-flow-col gap-4">
            <Link to="/sigin" label="Login">Login</Link>
            <Link to="/event" label="Event">Events</Link>
            <Link to="/gallery" label="Gallery">Gallery</Link>
          </div>
          </div>
        </div>
      </footer>
